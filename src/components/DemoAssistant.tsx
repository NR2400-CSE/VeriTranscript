...
//   { role: "Student", name: "Prateet", address: "0x7A57D75bd2e50175306Dc105af8de4bAba44Bb41" },
...
//     student: "0x7A57D75bd2e50175306Dc105af8de4bAba44Bb41",
//   },
//   {
//     name: "Krishna Garg",
...
//       setSeedStatus("✓ 3 test credentials seeded successfully!");
...
//         <div className="hidden sm:flex items-center gap-2 px-3.5 py-2 bg-slate-900/90 backdrop-blur-md border border-slate-800 rounded-full text-[11px] text-slate-300 font-mono shadow-xl">
...
//           <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-lg w-full space-y-6 shadow-2xl text-white">
...
//                 className="w-8 h-8 rounded-xl bg-slate-800 text-slate-400 hover:text-white flex items-center justify-center text-sm transition cursor-pointer"
//               >
//                 ✕
//               </button>
//             </div>
...
//                 </span>
//                 <span className="text-[10px] text-emerald-300 font-mono">3 Degrees</span>
//               </div>
//               <p className="text-[11px] text-slate-400">
//                 Issues credentials on-chain for Prateet, Krishna Garg, and Alice Doe in one go.
//               </p>
//               <button
//                 onClick={handleSeedAll}
//                 disabled={isSeeding}
//                 className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-500 disabled:bg-slate-700 text-white text-xs font-bold rounded-xl shadow transition cursor-pointer"
//               >
//                 {isSeeding ? "Minting Credentials..." : "⚡ Auto-Seed 3 Sample Degrees On-Chain"}
//               </button>
//               {seedStatus && (
//                 <p className="text-[11px] text-center font-mono text-emerald-400 animate-pulse">
//                   {seedStatus}
//                 </p>
//               )}
//             </div>
...
//                   <div
//                     key={i}
//                     className="p-2.5 bg-slate-950/70 border border-slate-800/80 rounded-xl flex items-center justify-between gap-3 text-xs"
//                   >
//                     <div>
...
//                       className="px-2.5 py-1 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg font-mono text-[11px] transition cursor-pointer shrink-0"
//                     >
